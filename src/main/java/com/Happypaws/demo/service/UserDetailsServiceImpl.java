...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email)
        ...
        // Bloqueo temporal por intentos fallidos (fuerza bruta): ver
        // LoginAttemptService y LoginAttemptListener. Al superar el máximo
        // de intentos, accountNonLocked pasa a false y Spring Security
        // lanza LockedException aunque la contraseña sea correcta.
        boolean accountNonLocked = !loginAttemptService.isBlocked(email);
