...
/**
 * Versión paginada del listado, usada por la vista de índice para no
 * cargar el catálogo completo en memoria/HTML cuando crece.
 * {@link #listar()} se conserva para los selects de formularios
 * (ventas, compras) que sí necesitan todos los productos a la vez.
 */
@Transactional(readOnly = true)
...
/** Cuenta productos sin cargar la lista completa en memoria. */
@Transactional(readOnly = true)
public long contar() {
