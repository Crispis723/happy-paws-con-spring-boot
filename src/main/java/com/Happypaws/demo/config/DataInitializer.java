    ...
    CommandLineRunner seedData(
        ...
        return args -> {
            ...
            Map<String, String> permissions = Map.ofEntries(
                    ...
                    // Hospitalización
                    Map.entry("HOSPITALIZACION_VER",
                            "Ver hospitalizaciones"),
                    Map.entry("HOSPITALIZACION_CREAR",
                            "Registrar ingresos a hospitalización"),
                    Map.entry("HOSPITALIZACION_EDITAR",
                            "Registrar controles y dar de alta"),
                    Map.entry("HOSPITALIZACION_ELIMINAR",
            ...
            Map<String, String[]> moduleCatalog = Map.ofEntries(
                ...
                Map.entry("HOSPITALIZACION", new String[]{"Hospitalización","/hospitalizacion","bi-hospital"}),
            ...
            addPermissions(
                    ...
                    "HOSPITALIZACION_VER",
                    "HOSPITALIZACION_CREAR",
                    "HOSPITALIZACION_EDITAR",
