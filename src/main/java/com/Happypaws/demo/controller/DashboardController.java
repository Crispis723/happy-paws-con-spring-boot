...
public class DashboardController {
    ...
    public DashboardController(
            ...
            HospitalizacionService hospitalizacionService) {
    ...
    public ResponseEntity<byte[]> exportar() {
        String csv = "modulo,total\n"
                + "clientes," + clienteService.contar() + "\n"
                + "mascotas," + petService.contar() + "\n"
                + "citas," + appointmentService.contar() + "\n"
                + "hospitalizadas_activas," + hospitalizacionService.contarActivas() + "\n"
                + "productos," + productoService.contar() + "\n"
                + "compras," + compraService.contar() + "\n"
                + "ventas," + ventaService.contar() + "\n"
                + "proveedores," + proveedorService.contar() + "\n"
                + "usuarios," + userService.contar() + "\n";
    ...
    private void addDashboardData(Model model, Authentication authentication) {
        ...
        model.addAttribute("totalMascotas", petService.contar());
        model.addAttribute("totalCitas", appointmentService.contar());
        model.addAttribute("totalHospitalizadas", hospitalizacionService.contarActivas());
        model.addAttribute("totalProductos", productoService.contar());
        model.addAttribute("totalCompras", compraService.contar());
        model.addAttribute("totalVentas", ventaService.contar());
        model.addAttribute("totalProveedores", proveedorService.contar());
        model.addAttribute("totalUsuarios", userService.contar());
    }
}
