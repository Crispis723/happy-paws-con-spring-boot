...
public class ReportesController {
    ...
    public String financieros(Model model) {
        // Antes esto llamaba a ventaService.listar() tres veces seguidas
        // (una por cada model.addAttribute), disparando la misma consulta
        // a la base de datos tres veces para la misma petición HTTP.
